# Comment:
# Gere la communication serie avec les moteurs Dynamixel
# Fournit des methodes pour ouvrir, fermer et configurer le port serie, ainsi que pour envoyer et recevoir des donnees via ce port 
