# Comment:
# Gere les paquets de communication avec les moteurs Dynamixel
# la fonction retourne une instance du gestionnaire de paquets approprie en fonction de la version du protocole
